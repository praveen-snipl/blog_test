class ArticlesController < ApplicationController
  ...
  # GET /articles
  # GET /articles.json
  # after_action :article_observer, :only => [ :create, :update, :destroy ]
  caches_action :show

  after_action :load_metrics, :only => [ :update ]
  ...
  def create
    ...
    respond_to do |format|
      if @article.save
        ...
        format.json { render article_path(@article) }
      else
